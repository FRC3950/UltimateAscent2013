...
//Gyro* RobotMap::gyroSubsystemGyro = NULL;
SpeedController* RobotMap::armMotorSubsystemSpeedController = NULL;
void RobotMap::init() {
	...
	armPIDSubsystemPotentiometer1 = new AnalogChannel(1, 2);
	lw->AddSensor("Arm PID Subsystem", "Potentiometer 1", armPIDSubsystemPotentiometer1);
	
	armPIDSubsystemSpeedController1 = new Victor(1, 5);
	lw->AddActuator("Arm PID Subsystem", "Speed Controller 1", (Victor*) armPIDSubsystemSpeedController1);
	
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        
        armMotorSubsystemSpeedController  = new Talon(1, 6);
        lw->AddActuator("ArmMotorubsystem", "Speed Controller", (Talon*) armMotorSubsystemSpeedController);
