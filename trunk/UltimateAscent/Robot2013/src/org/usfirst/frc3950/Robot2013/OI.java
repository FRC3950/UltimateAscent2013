...
public class OI {
    ...
    public JoystickButton startAutomaticClimb;
    ...
    public OI() {
        ...
        startAutomaticClimb = new JoystickButton(climberStick, 1);
        startAutomaticClimb.whenPressed(new AutomaticClimb());
        ...
        SmartDashboard.putData("Automatic Climb", new AutomaticClimb());
        ...
        SmartDashboard.putData("Climber Screw", new ClimberScrew());
