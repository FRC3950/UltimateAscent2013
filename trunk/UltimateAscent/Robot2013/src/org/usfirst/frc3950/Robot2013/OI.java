...
public class OI {
    ...
    public JoystickButton increaseAngle;
    public JoystickButton decreaseAngle;
    ...
    public JoystickButton maxShooterSpeedButton;
    public OI() {
        ...
        maxShooterSpeedButton = new JoystickButton (shooterStick,8);
        maxShooterSpeedButton.whenPressed(new MaxShootSpeedCommandGroup());
        decreaseAngle = new JoystickButton(shooterStick, 7);
        decreaseAngle.whenPressed(new DecreaseAnglingErrorCorrectionValue());
        increaseAngle = new JoystickButton(shooterStick, 6);
        increaseAngle.whenPressed(new IncreaseAnglingErrorCorrectionValue());
        ...
        highGoalTargetingButton.whenPressed(new HighGoalPlusWheels());
        middleGoalTargetingButton = new JoystickButton(shooterStick, 4);
        middleGoalTargetingButton.whenPressed(new FixedShooterAngleCommand());
...
//        stopBelt2.whenReleased(new ConveyorBeltDoNothing());
        stopWheels = new JoystickButton(shooterStick, 2);
        stopWheels.whenPressed(new StopBothWheelsCommandGroup());
