...
public class RobotMap {
    ...
    public static PIDController shooterShooterScrew;
    public static SpeedController shooterBelt;
	...
	LiveWindow.addSensor("Drive Train", "Accelerometer", driveTrainAccelerometer);
        ...
        climberClimbingScrew = new Victor(1, 6);
	LiveWindow.addActuator("Climber", "Climbing Screw", (Victor) climberClimbingScrew);
        
        climberClimbingSolenoid = new DoubleSolenoid(1, 5, 6);      
	
        
        shooterSpeedController1 = new Victor(1, 7);
	LiveWindow.addActuator("Shooter", "Speed Controller 1", (Victor) shooterSpeedController1);
	...
	LiveWindow.addActuator("Shooter", "Speed Controller 2", (Victor) shooterSpeedController2);
        ...
        shooterEncoder2 = new Encoder(1, 4, 1, 6, false, EncodingType.k4X);
	...
	LiveWindow.addActuator("Shooter", "Wheel2", shooterWheel2);
        ...
        shooterScrewSpeedController = new Victor(1, 5);
	LiveWindow.addActuator("Shooter", "Screw Speed Controller", (Victor) shooterScrewSpeedController);
        
        shooterPotentiometer = new AnalogChannel(1, 3);
	LiveWindow.addSensor("Shooter", "Potentiometer", shooterPotentiometer);
        
        shooterShooterScrew = new PIDController(1.0, 0.0, 0.0, 0.0, shooterPotentiometer, shooterScrewSpeedController, 0.02);
	LiveWindow.addActuator("Shooter", "Shooter Screw", shooterShooterScrew);
        shooterShooterScrew.setContinuous(false); shooterShooterScrew.setAbsoluteTolerance(0.2); 
        shooterShooterScrew.setOutputRange(-1.0, 1.0);        
        shooterBelt = new Victor(1, 9);
	LiveWindow.addActuator("Shooter", "Belt", (Victor) shooterBelt);
