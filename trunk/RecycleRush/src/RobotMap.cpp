...
void RobotMap::init() {
...
#if 0
	// Not hooked up yet.
	gantrySubsystemRestraintControlSolenoid = new DoubleSolenoid(0, 3, 4);      
	lw->AddActuator("DoorControlSubsystem", "DoorSolenoid", gantrySubsystemRestraintControlSolenoid);
	...
	gantrySubsystemRestraintControlSolenoid = new Solenoid(0, 3);
