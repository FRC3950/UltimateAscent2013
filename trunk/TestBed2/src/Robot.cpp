...
static const std::string ConfigFileName = "RobotConfig.csv";
	  ...
	  lw(NULL)
{
		...
		int x = ConfigInstanceMgr::getInstance()->getIntVal("X", 3);
		int y = ConfigInstanceMgr::getInstance()->getIntVal("Y", 1);

		logger->Log(RobotLogId, Logger::kINFO, "X = %d", x);
		logger->Log(RobotLogId, Logger::kINFO, "Y= %d", y);
}
