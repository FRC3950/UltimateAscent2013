...
#include "Commands/FireLiftSolenoidCommand.h"
#include "UtilFun.h"
...

{
	...
	fireLiftSolenoidButton = new JoystickButton(driveJoystick, 7);

	fireLiftSolenoidButton->WhenPressed(new FireLiftSolenoidCommand());
}
