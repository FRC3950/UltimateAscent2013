...
public class RobotMap {
    ...
    public static DigitalInput shootingScrewAngleLowerLimit;
    public static SpeedController conveyorBeltBelt;
    public static Compressor pneumaticsCompressor;
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    public static DigitalInput shootingScrewAngleUpperLimit;
	...
	LiveWindow.addActuator("Wheel One", "Speed Con troller 1", (Victor) wheelOneSpeedController1);
	...
	LiveWindow.addActuator("Shooting Screw", "Shooter Screw", shootingScrewShooterScrew);
        ...
        shootingScrewAngleLowerLimit = new DigitalInput(1, 10);
	LiveWindow.addSensor("Shooting Screw", "Angle Lower Limit", shootingScrewAngleLowerLimit);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        shootingScrewAngleUpperLimit = new DigitalInput(1, 11);
        LiveWindow.addSensor("Shooting Screw", "Angle Upper Limit", shootingScrewAngleUpperLimit);
    }
}
