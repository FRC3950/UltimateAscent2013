...
public class OI {
    ...
    public JoystickButton mysteryShot;
    ...
    public JoystickButton reverseWheels;
    ...
    public OI() {
        ...
        reverseWheels = new JoystickButton(shooterStick, 2);
        reverseWheels.whileHeld(new ReverseShooterWheels());
        ...
        mysteryShot = new JoystickButton(shooterStick, 5);
        mysteryShot.whenPressed(new Mystery());
        ...
        cancelClimb = new JoystickButton(rightDrive, 9);
        cancelClimb.whenPressed(new Cancel());
        startClimb = new JoystickButton(rightDrive, 8);
        ...
        SmartDashboard.putData("ShiftGears", new ShiftGears());

        SmartDashboard.putData("Automatic", new Automatic());

        SmartDashboard.putData("SemiAutomatic", new SemiAutomatic());
        ...
        SmartDashboard.putData("Wheel1Fast", new Wheel1Fast());

        SmartDashboard.putData("Wheel1Slow", new Wheel1Slow());

        SmartDashboard.putData("Wheel2Fast", new Wheel2Fast());

        SmartDashboard.putData("Wheel2Slow", new Wheel2Slow());

        SmartDashboard.putData("Screw", new Screw());

        SmartDashboard.putData("ReverseShooterWheels", new ReverseShooterWheels());

        SmartDashboard.putData("Mystery", new Mystery());
