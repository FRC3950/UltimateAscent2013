...
public class OI {
    ...
    public JoystickButton semiAutoShot;
    ...
    public OI() {
        ...
        doNotShoot = new JoystickButton(climberStick, 11);
        doNotShoot.whenReleased(new DoNotShootCommandGroup());
        semiAutoShot = new JoystickButton(climberStick, 11);
        semiAutoShot.whileHeld(new AutoFireFourCommandGroup());
        goToLoadAngle = new JoystickButton(climberStick, 1);
        goToLoadAngle.whenPressed(new LoadAngle());
        highGoalTargetingButton = new JoystickButton(climberStick, 5);
        highGoalTargetingButton.whenPressed(new HighGoalVisionTargeting());
        middleGoalTargetingButton = new JoystickButton(climberStick, 4);
        ...
        stopWheels = new JoystickButton(shooterStick, 4);
