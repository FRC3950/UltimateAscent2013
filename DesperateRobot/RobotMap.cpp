...
DoubleSolenoid* RobotMap::shooterSubsystemTriggerSolenoid = NULL;
...
void RobotMap::init() {
	...
	driveSubsystemSpeedController1 = new Victor/*Was here*/(1, 1);
	...
	shooterSubsystemTriggerSolenoid = new DoubleSolenoid(1, 4, 5);
	lw->AddActuator("Shooter Subsystem", "Trigger Solenoid", shooterSubsystemTriggerSolenoid);
		
	intakeSubsystemClawSolenoid = new DoubleSolenoid(1, 6, 7);
