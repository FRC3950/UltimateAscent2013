...
OI::OI() {
	...
	launchAngleButton = new JoystickButton(yellowJoystick, 2);
...
bool OI::GetTopButton()
{
	return yellowJoystick->GetRawButton(4);	
}
bool OI::GetShootButton()
{
	return yellowJoystick->GetRawButton(5);	
}
bool OI::GetBottomButton()
{
